    ...
    <div class="col-xl-3 col-sm-6 mb-3">
      <div class="card text-white bg-warning o-hidden h-100">
        <div class="card-body">
          ...
          <?php
          $ambil = $koneksi->query("SELECT COUNT(*) FROM tbl_barang");
          $pecah = $ambil->fetch_assoc();

          ?>

          <div class="mr-5"><?php echo $pecah['COUNT(*)'] ?> Menu Makanan</div>
        </div>
    ...
    <div class="col-xl-3 col-sm-6 mb-3">
      <div class="card text-white bg-success o-hidden h-100">
        <div class="card-body">
          ...
          <?php
          $ambil = $koneksi->query("SELECT * FROM tbl_member");
          $pecah  = mysqli_num_rows($ambil);
          ?>
          <div class="mr-5"><?php echo $pecah ?> Member</div>
        </div>
        <a class="card-footer text-white clearfix small z-1" href="#">
          <span class="float-left">Lihat Details</span>
          <span class="float-right">
